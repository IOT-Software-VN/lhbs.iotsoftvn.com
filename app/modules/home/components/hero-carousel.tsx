...
import { ScrollIndicator } from '@/components/ui/ScrollIndicator' // Giả sử đường dẫn đúng
            ...
            >
              ...
              >
                <button
                  ...
                  className='group relative px-5 py-2.5 md:px-7 md:py-3 lg:px-8 lg:py-3.5 bg-brand-gold text-brand-green font-bold text-[10px] md:text-xs lg:text-sm uppercase tracking-widest rounded-sm md:rounded 
