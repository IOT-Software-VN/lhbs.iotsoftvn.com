      ...
      <div className='grow w-full max-w-[1920px] mx-auto px-4 md:px-12 lg:px-16 relative z-10 overflow-y-auto no-scrollbar py-8 md:py-12 flex flex-col justify-center'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 grow h-full pt-4'>
          ...
          >
            ...
            <div className='flex flex-col gap-4 mb-6 grow'>
              {newsItems.slice(1).map((item, index) => (
                <div
                  key={index}
                  className='p-3 cursor-pointer bg-gray-50 border border-gray-100 hover:border-brand-green/20 hover:bg-brand-gold/10 transition-all rounded-sm group/item grow flex items-center'
            ...
            <div className='mt-auto pt-2 shrink-0'>
              <button
                ...
                className='flex items-center gap-3 px-6 py-2.5 bg-brand-green text-white font-bold uppercase tracking-wide text-xs rounded-full hover:bg-brand-gold hover:text-brand-green transition-all shadow-lg group/btn'
              >
                <span>Xem thêm</span>
          ...
          >
            ...
            {/* Title Below Image */}
            <h4
              className='text-base font-bold text-brand-green leading-tight drop-shadow-sm group-hover:text-brand-gold transition-colors mb-6 cursor-pointer'
              onClick={() => onNavigate(galleryItem.link)}
            >
              {galleryItem.title}
            </h4>
