    ...
    >
      ...
      <div className='w-full h-full max-w-[1920px] mx-auto px-4 md:px-12 lg:px-16 relative z-20'>
        ...
        >
          ...
          <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-brand-green uppercase tracking-tight drop-shadow-2xl'>
            LHBS trong tôi là
          </h2>
        </motion.div>
          ...
          >
            <div className='w-full'>
              <Carousel className='w-full flex items-center relative' opts={{ loop: true }}>
                {/* Custom Navigation */}
                <CarouselPrevious className='absolute left-0 -ml-2 md:-ml-8 h-auto w-auto border-none bg-transparent text-brand-gold hover:bg-transparent hover:text-[#d49e19] [&_svg]:size-8 md:[&_svg]:size-12 transition-transform hover:scale-110 z-30' />
                ...
                <CarouselNext className='absolute right-0 -mr-2 md:-mr-8 h-auto w-auto border-none bg-transparent text-brand-gold hover:bg-transparent hover:text-[#d49e19] [&_svg]:size-8 md:[&_svg]:size-12 transition-transform hover:scale-110 z-30' />
              </Carousel>
            </div>
          </motion.div>
