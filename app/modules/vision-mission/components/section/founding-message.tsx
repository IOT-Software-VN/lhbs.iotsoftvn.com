...
const bgAcademicBilingual = '/images/tam-nhin-su-menh-page/triet-ly-bg.png'
const founderImage = '/images/base/thay-tai.png'

// ==================== SECTION 2: Founding Message ====================
export function FoundingMessageSection() {
        ...
        >
          ...
          <div className='w-full h-auto md:h-full md:overflow-y-auto no-scrollbar p-8 pb-12 md:p-8 lg:p-12 xl:p-16 2xl:p-24 flex flex-col justify-center'>
            <div className='flex flex-col gap-3 md:gap-4 lg:gap-6 xl:gap-8'>
              {/* Header Group */}
              <div>
                <div className='bg-brand-gold w-12 h-1 md:w-16 md:h-1.5 mb-3 md:mb-4 rounded-full shadow-[0_0_15px_rgba(250,186,30,0.4)]' />
                <h3 className='text-xs md:text-sm lg:text-base xl:text-lg font-bold text-brand-gold uppercase tracking-[0.15em] mb-2'>
              ...
              {/* Quote Icon */}
              <div className='text-brand-gold text-2xl md:text-3xl lg:text-4xl xl:text-5xl opacity-80'>
                <ImQuotesRight />
              </div>

              {/* Body Copy */}
              <p className='text-white/90 text-sm md:text-base lg:text-lg xl:text-xl font-light leading-relaxed'>
                LHBS cam kết kiến tạo một môi trường học tập nhân văn, nuôi dưỡng và giáo dục thế hệ trẻ biết trân trọng
                cội nguồn và bản sắc Việt Nam, đồng thời sẵn sàng hội nhập quốc tế với tri thức, kỹ năng và phẩm chất
                công dân toàn cầu góp phần mang lại những thay đổi tích cực cho bản thân, cộng đồng và xã hội.
              </p>

              {/* Attribution */}
              <div className='border-l-4 border-brand-gold pl-3 md:pl-4 lg:pl-6'>
                <p className='text-base md:text-lg lg:text-xl xl:text-2xl text-white font-bold uppercase tracking-wide mb-1'>
                  TS. Đỗ Hữu Tài
                </p>
              ...
              {/* <div className='pt-2'>
                <motion.button
                  ...
                  className='group relative px-8 py-3 md:px-10 md:py-4 bg-brand-gold text-brand-green font-bold text-xs md:text-base uppercase tracking-widest rounded-sm 
