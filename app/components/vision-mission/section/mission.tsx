      ...
      <div className='container mx-auto px-4 md:px-8'>
        ...
        >
          ...
          <div className='flex flex-col items-center mb-6'>
            <div className='bg-[#FDB913] w-12 h-1 md:w-20 md:h-1.5 rounded-full' />
          </div>

          {/* Main Title 60px */}
          <h2 className='text-[32px] md:text-[48px] lg:text-[60px] font-black text-[#1E5338] uppercase tracking-tight leading-tight md:leading-tight mb-8 md:mb-12 max-w-5xl mx-auto'>
            SỨ MỆNH
          </h2>
