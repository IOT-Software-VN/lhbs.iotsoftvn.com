...
interface ExtracurricularActivitiesPageProps {
  onNavigate: (path: string) => void;
}

export function ExtracurricularActivitiesPage({ onNavigate }: ExtracurricularActivitiesPageProps) {
  return (
      ...
      <div className="relative w-full max-w-screen-xl mx-auto px-6 md:px-12 py-24 md:py-32">
        ...
        <nav className="mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2 text-sm">
            ...
            <li>
              <button 
                onClick={() => onNavigate('/student-life/outstanding-experiences')}
                className="text-[#fffae9]/70 hover:text-[#fffae9] transition-colors focus:outline-none focus:ring-2 focus:ring-[#FABA1E]"
              >
                Path To Passion
              </button>
