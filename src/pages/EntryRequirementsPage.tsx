...
import { ChevronRight, ChevronDown, Plus, Minus, Phone, Mail, ArrowRight } from 'lucide-react';
import { ImageWithFallback } from '../components/figma/ImageWithFallback';

interface EntryRequirementsPageProps {
  onNavigate: (path: string) => void;
}

export function EntryRequirementsPage({ onNavigate }: EntryRequirementsPageProps) {
  return (
