...
import { BookOpen, Lightbulb, Heart, Globe, Shield, Play, Pause, VolumeX } from 'lucide-react'
        ...
        <div className='flex flex-col gap-8 md:gap-10'>
                ...
                return (
                  <button
                    ...
                    className={`
                                            ...
                                            ${
                                              isActive
                                                ? 'bg-white text-brand-green shadow-[0_0_15px_rgba(255,255,255,0.3)] translate-x-0' // Active
          ...
          <div className='w-full lg:w-[75%]'>
            <AnimatePresence mode='wait'>
              ...
              >
                <div className=''>
                  <h3 className='text-2xl md:text-3xl font-black uppercase mb-3 text-lhbs-yellow'>
                    {selectedValue.title}
                  </h3>
