...
import { UserRound, MessageCircleHeart, Heart } from 'lucide-react';
import { cn } from '@/lib/utils';
import cardlhbs from '@assets/images/home-page/section-studentcare/card-lhbs.png';
import bgoverplay from '@assets/images/home-page/section-studentcare/bg-overplay.png';
...
const studentCareItems = [
  ...
  },
  {
    ...
    title: "Strong School–Home Communication",
    description: "We maintain open communication with families, sharing updates, progress, and helpful insights. This partnership ensures students receive consistent care and support both at school and at home.",
  },
  {
    id: 3,
    icon: Heart,
    title: "Emotional Support & Well-Being",
    description: "Teachers create a warm, caring environment where every child feels safe, heard, and understood. Students receive guidance that helps them manage emotions, build resilience, and develop healthy confidence.",
  },
];
...
{/* Section Header */}
          <div className='flex flex-col items-center mb-12'>
            ...
            {/* Giới hạn chiều rộng để tiêu đề ngắn gọn căn giữa tốt hơn */}
            <div className='max-w-4xl'>
              <h1 className='text-3xl md:text-4xl lg:text-5xl font-black text-[#1E5338] uppercase tracking-wide drop-shadow-sm text-center leading-tight'>
                Student Care
              </h1>
            </div>
          </div>
          <p className="text-sm md:text-base text-[#212121] font-medium max-w-4xl mx-auto leading-relaxed">
          We offer personalized care to ensure every child feels safe and supported. Teachers monitor each student’s well-being emotionally and academically, fostering confidence. With open communication and a nurturing environment, students build resilience and a sense of belonging.          </p>
        </motion.div>
