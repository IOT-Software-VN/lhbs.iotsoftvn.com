...
export function metaTag() {
  return [
    ...
    { property: 'og:site_name', content: 'Trường song ngữ Lạc Hồng' },
    {
      ...
      content: 'https://lhbs.edu.vn/wp-content/uploads/2021/05/cropped-ky-niem-10-nam-lhbs-270x270.png'
    }
  ]
}
...
export function ErrorBoundary({ error }: Route.ErrorBoundaryProps) {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-[#1a5336] to-[#0f3a26] flex items-center justify-center px-4'>
