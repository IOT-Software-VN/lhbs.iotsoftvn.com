...
export function ScrollIndicator({ targetSectionId = 'solid-education-level' }: ScrollIndicatorProps) {
  ...
  const handleScrollClick = () => {
    ...
    if (targetElement) {
      ...
      const offset = 0 // Adjusted to 0 to fit the section exactly
