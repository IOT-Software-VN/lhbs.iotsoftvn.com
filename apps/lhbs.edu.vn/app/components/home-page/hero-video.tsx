  ...
  return (
    <section className='relative w-full h-screen min-h-[600px] flex items-center overflow-hidden'>
      ...
      <div className='absolute inset-0 z-10'>
        ...
        <div className='absolute inset-0 bg-linear-to-tr from-black/50 via-transparent to-transparent'></div>
      </div>
          ...
          >
            ...
            >
              <h1 className='whitespace-nowrap'>
                <AnimatedHighlight delay={0.6} duration={1.2} backgroundColor='#FABA1E'>
                  <span
            ...
            >
              Lac Hong Bilingual School is a leading bilingual school in Dong Nai, where every student is nurtured to
              develop intellectually, ethically, and globally competent in the digital era. <br />
              The school preserves and promotes Vietnamese cultural values while fostering creativity, lifelong
              learning, and social responsibility, empowering students to become compassionate, confident, innovative,
              and adaptable citizens in an ever-changing world.
            </motion.p>
