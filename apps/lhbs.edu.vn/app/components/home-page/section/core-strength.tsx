...
interface CoreStrengthsSectionProps {
  ...
  setShowModal: (
    modal: { title: string; description: string; points: string[]; image: string; alt: string } | null
  ) => void
}
  ...
  const pillars = [
    ...
    },
    {
      ...
      icon: (
        <svg className='w-16 h-16' viewBox='0 0 64 64' fill='none' stroke='#1a5336' strokeWidth='1.5'>
          <path
            d='M32 52 C32 52 12 36 12 24 C12 18 16 14 22 14 C26 14 30 16 32 20 C34 16 38 14 42 14 C48 14 52 18 52 24 C52 36 32 52 32 52 Z'
    ...
    },
    {
      ...
      description:
        'We take initiative and accountability for ourselves, our society, and our planet, acting for sustainable development.',
      points: [
  ...
  return (
    ...
    >
      <div className='text-center mb-16 relative z-10'>
        ...
        >
          Our Holistic educational programs equip our students with the essential life values necessary for personal
          growth and success.
        </motion.p>
      </div>
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <div className='flex-1 flex items-center justify-center relative z-10 py-4'>
                <div className='transform scale-125'>{pillar.icon}</div>
              </div>
              ...
              <div className='absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20'>
                ...
                >
                  <img src={pillar.image} alt={`${pillar.title} at LHBS`} className='w-full h-full object-cover' />
                </div>
              </div>
    ...
    >
      ...
      >
        ...
        <div className='p-8 md:p-12'>
          ...
          <p className='text-lg md:text-xl text-[#212121] leading-relaxed mb-8'>{description}</p>
