      ...
      <div className='w-full px-4 md:px-10 grid md:grid-cols-2 gap-16 items-center relative z-10'>
        ...
        >
          <h2 className="text-[#1a5336] mb-6 font-['SVN-Gotham']" style={{ fontSize: '48px', lineHeight: '1.24' }}>
            ...
            {/* Main title */}
            <span className='block text-[#1a5336]'>College Acceptances</span>
          </h2>

          {/* Body content */}
          <div className='text-base md:text-lg text-[#212121] mb-8 leading-relaxed max-w-[70ch]'>
            <p className='mb-6'>
              Year after year, LHBS learners are welcomed into renowned international universities, a testament to our
              strong academic foundation and comprehensive counseling support.
            </p>
          </div>
