...
import placeholder from "@assets/images/base/default.jpg"
const dailyActivities = [
  {
    id: 1,
    title: "Arrival & Free Play",
    description:
      "Children are welcomed warmly and ease into the day with soft activities, building social confidence and independence.",
    image:
      placeholder,
  ...
  },
  {
    ...
    description:
      "A group gathering to sing, share stories, review the day’s schedule, and build communication skills.",
    image:
      placeholder,
  ...
  },
  {
    ...
    title: "Creative Play",
    description:
      "Structured lessons in literacy, math, science, and language arts delivered through play-based, hands-on activities.",
    image:
      placeholder,
  ...
  },
  {
    ...
    description:
      "Children explore, run, climb, and engage in physical activities that develop motor skills and teamwork.",
    image:
      placeholder,
          ...
          <div className='flex flex-col items-center mb-12'>
            ...
            <div className='max-w-4xl'>
              <h3 className='text-3xl md:text-4xl lg:text-5xl font-black text-[#1E5338] uppercase tracking-wide drop-shadow-sm text-center leading-tight'>
                A Day of Kindergarten Students
              </h3>
            </div>
          </div>
          <p className="text-[#212121] font-medium text-lg max-w-3xl mx-auto">
            Our excursions link curriculum to real-world experiences. Exploring nature enhances science studies and engaging with cultural institutions broadens awareness, fostering curiosity and critical thinking.
          </p>
        </div>
